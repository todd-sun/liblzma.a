...
int decode_file(const char *in_file_name, const char* out_file_name, char* buf)
{
	char *argvs[4];
	argvs[0] = NULL;
	argvs[1] = (char *)"d";
	argvs[2] = (char *)in_file_name;
	argvs[3] = (char *)out_file_name;
	return main2(4, (const char**)argvs, buf);
}


int encode_file(const char *in_file_name, const char* out_file_name, char* buf)
{
	char *argvs[4];
	argvs[0] = NULL;
	argvs[1] = (char *)"e";
